    ...
    <ion-content :fullscreen="true">
      ...
      <div id="container mt-96">
        ...
        <div class="bg-white py-5">
          <p class="text-center text-blue-600 text-3xl pt-10 mb-10">Système biométrique</p>
...
export default defineComponent({
  ...
  mounted () {
    fetch(`https://ezcurity.herokuapp.com/api/plans/biometric`)
    ...
    .then(data => {
      ...
      return this.services = data['biometric']
    })
